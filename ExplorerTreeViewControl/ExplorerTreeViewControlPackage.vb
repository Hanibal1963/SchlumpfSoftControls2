...
<Guid(ExplorerTreeViewControlPackage.PackageGuidString)>
Public NotInheritable Class ExplorerTreeViewControlPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "27ef1c44-dbc5-4ed9-a0b2-335d1a4c6454"
