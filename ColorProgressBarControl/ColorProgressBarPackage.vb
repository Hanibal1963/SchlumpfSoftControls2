...
<Guid(ColorProgressBarPackage.PackageGuidString)>
Public NotInheritable Class ColorProgressBarPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "97c2ef90-575d-4140-804e-4360e541a0d2"
