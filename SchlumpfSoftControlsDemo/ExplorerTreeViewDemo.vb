...
Public Class ExplorerTreeViewDemo
    ...
    Private Sub ExplorerTreeView1_SelectedPathChanged(sender As Object, e As SelectedPathChangedEventArgs) Handles ExplorerTreeView1.SelectedPathChanged
