        ...
        Select Case True
            Case sender Is Me.ComboBox_Design
                Select Case selindex ' Design ändern
                    Case 0
                        Me.NotifyForm1.Design = NotifyFormDesign.Bright ' Helles Desing
                    Case 1
                        Me.NotifyForm1.Design = NotifyFormDesign.Colorful ' Farbiges Desing
                    Case 2
                        Me.NotifyForm1.Design = NotifyFormDesign.Dark ' Dunkles Desing
                End Select
            Case sender Is Me.ComboBox_Style
                Select Case selindex  ' Style ändern
                    Case 0
                        Me.NotifyForm1.Style = NotifyFormStyle.Information  ' Infosymbol
                    Case 1
                        Me.NotifyForm1.Style = NotifyFormStyle.Question ' Fragesymbol
                    Case 2
                        Me.NotifyForm1.Style = NotifyFormStyle.CriticalError ' Fehlersymbol
                    Case 3
                        Me.NotifyForm1.Style = NotifyFormStyle.Exclamation  ' Hinweissymbol
                End Select
        End Select
    End Sub
