    ...
    Private Sub ComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox_ShapeModus.SelectedIndexChanged, ComboBox_LineStart.SelectedIndexChanged
        ...
        Select Case True
            Case sender Is ComboBox_ShapeModus ' Form des Shapes schalten
                Select Case index
                    Case 0
                        Me.Shape1.ShapeModus = Shape.ShapeModes.HorizontalLine
                    Case 1
                        Me.Shape1.ShapeModus = Shape.ShapeModes.VerticalLine
                    Case 2
                        Me.Shape1.ShapeModus = Shape.ShapeModes.DiagonalLine
                    Case 3
                        Me.Shape1.ShapeModus = Shape.ShapeModes.Rectangle
                    Case 4
                        Me.Shape1.ShapeModus = Shape.ShapeModes.FilledRectangle
                    Case 5
                        Me.Shape1.ShapeModus = Shape.ShapeModes.Ellipse
                    Case 6
                        Me.Shape1.ShapeModus = Shape.ShapeModes.FilledEllipse
                End Select
            Case sender Is ComboBox_LineStart ' Startpunkt der Linie schalten
                Select Case index
                    Case 0
                        Me.Shape1.DiagonalLineModus = Shape.DiagonalLineModes.TopLeftToBottomRight
                    Case 1
                        Me.Shape1.DiagonalLineModus = Shape.DiagonalLineModes.BottomLeftToTopRight
                End Select
        End Select
    End Sub
