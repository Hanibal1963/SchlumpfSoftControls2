Public Class Form1
    ...
    Private Sub EntryValueEdit_ValueChanged(sender As Object, e As SchlumpfSoft.Controls.IniFileControl.EntryValueEditEventArgs) Handles EntryValueEdit.ValueChanged
        ' Eintragwert ändern
        Me.IniFile.SetEntryValue(e.SelectedSection, e.SelectedEntry, e.NewValue)
    End Sub

    Private Sub FileCommentEdit_CommentChanged(sender As Object, e As SchlumpfSoft.Controls.IniFileControl.CommentEditEventArgs) Handles FileCommentEdit.CommentChanged
        ' Dateikommentar speichern
        Me.IniFile.SetFileComment(e.Comment)
    End Sub

    Private Sub EntryListEdit_ItemAdd(sender As Object, e As SchlumpfSoft.Controls.IniFileControl.ListEditEventArgs) Handles EntryListEdit.ItemAdd
        ' Eintrag hinzufügen
        Me.IniFile.AddEntry(e.SelectedSection, e.NewItemName)
    End Sub

    Private Sub EntryListEdit_ItemRename(sender As Object, e As SchlumpfSoft.Controls.IniFileControl.ListEditEventArgs) Handles EntryListEdit.ItemRename
        ' Eintrag umbenennen
        Me.IniFile.RenameEntry(e.SelectedSection, e.SelectedItem, e.NewItemName)
    End Sub

    Private Sub EntryListEdit_ItemRemove(sender As Object, e As SchlumpfSoft.Controls.IniFileControl.ListEditEventArgs) Handles EntryListEdit.ItemRemove
        ' Eintrag löschen
        Me.IniFile.DeleteEntry(e.SelectedSection, e.SelectedItem)
    End Sub

    Private Sub EntryListEdit_SelectedItemChanged(sender As Object, e As SchlumpfSoft.Controls.IniFileControl.ListEditEventArgs) Handles EntryListEdit.SelectedItemChanged
    ...
    Private Sub SectionsListEdit_ItemAdd(sender As Object, e As SchlumpfSoft.Controls.IniFileControl.ListEditEventArgs) Handles SectionsListEdit.ItemAdd
        ' Abschnitt hinzufügen
        Me.IniFile.AddSection(e.NewItemName)
    End Sub

    Private Sub SectionsListEdit_ItemRename(sender As Object, e As SchlumpfSoft.Controls.IniFileControl.ListEditEventArgs) Handles SectionsListEdit.ItemRename
        ' Abschnitt umbenennen
        Me.IniFile.RenameSection(e.SelectedItem, e.NewItemName)
    End Sub

    Private Sub SectionsListEdit_ItemRemove(sender As Object, e As SchlumpfSoft.Controls.IniFileControl.ListEditEventArgs) Handles SectionsListEdit.ItemRemove
        ' Abschnitt löschen
        Me.IniFile.DeleteSection(e.SelectedItem)
    End Sub

    Private Sub SectionsListEdit_SelectedItemChanged(sender As Object, e As SchlumpfSoft.Controls.IniFileControl.ListEditEventArgs) Handles SectionsListEdit.SelectedItemChanged
    ...
    Private Sub SectionCommentEdit_CommentChanged(sender As Object, e As SchlumpfSoft.Controls.IniFileControl.CommentEditEventArgs) Handles SectionCommentEdit.CommentChanged
