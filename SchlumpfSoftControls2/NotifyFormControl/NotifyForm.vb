...
#End Region
        ...
        Public Sub New()
            _Title = $"Titel"
            _Message = $"Mitteilung"
            _Design = NotifyFormDesign.Bright
            _Style = NotifyFormStyle.Information
            _ShowTime = 5000
        End Sub
        ...
        Public Sub Show()
            ...
            FormTemplate.Title = _Title
            FormTemplate.Message = _Message
            FormTemplate.ShowTime = _ShowTime
            SetFormDesign()
        End Sub
